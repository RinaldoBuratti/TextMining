...
public class PatternMatcher {
	public static HashMap<String, ArrayList<String>> match(String doc) {
		...
		patterns.put("telephone", "( )([+]?[0-9]{2,4})?( )?[3|0][0-9]{1,3}(/|-| |.|)[0-9]{6,10}");
	...
	public static void main(String[] args) {
		String s = " 06 9077225 Luca Avolio +39 332 28690664867 Rinaldo Troia martina@gmail.com 06 9077225 Rinaldo Buratti luca@uniroma3.it";
